...
MISSION_SEEDS = [
    ...
    ('streak_3',       'Tres Días Ahorrando',  'Mantén una racha de ahorro de 3 días',              '🐷', 'streak',         3,   50),
    ('streak_7',       'Semana de Ahorro',     'Ahorra 7 días seguidos sin exceder tu presupuesto', '🌟', 'streak',         7,   150),
    ('streak_30',      'Leyenda del Ahorro',   'Mantén una racha de ahorro de 30 días',             '👑', 'streak',         30,  500),
